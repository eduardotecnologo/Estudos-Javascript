        ...
        <div className="row">
          <div className="col-md-12">
            <div className="jumbotron text-center">
              <h2>Pesquise pelo seu artista aqui!</h2>
              <form>
                <div className="col-md-6 col-md-offset-3">
                  <div className="input-group input-group-lg">
                    <input ref="artistName" type="text" className="form-control" placeholder="Ex: Bonde do Safadão" onChange={this.setInputFieldValue} />
                    <span className="input-group-btn">
                      <button className="btn btn-default" type="button" onClick={this.searchItems}>Buscar!</button>
                    </span>
                  </div>
                </div>
              </form>
